# Latest Releases for the week 2025-04-07 - 2025-04-14   
## kubernetes-sigs/cluster-api  
### Release notes for v1.10.0-rc.0  
#### [cluster-api v1.10.0-rc.0](https://github.com/kubernetes-sigs/cluster-api/releases/tag/v1.10.0-rc.0)  
#### 2025-04-08  
...
### Release notes for v1.13.0-rc.0  
#### [cluster-api-provider-vsphere v1.13.0-rc.0](https://github.com/kubernetes-sigs/cluster-api-provider-vsphere/releases/tag/v1.13.0-rc.0)  
#### 2025-04-09  
...
- k8s.io/utils: 18e509b → 3ea5e8c
- sigs.k8s.io/apiserver-network-proxy/konnectivity-client: v0.30.3 → v0.31.0
- sigs.k8s.io/cluster-api: v1.9.1 → v1.10.0-rc.0
- sigs.k8s.io/controller-runtime: v0.19.3 → v0.20.4
- sigs.k8s.io/json: bc3834c → 9aa6b5e
- sigs.k8s.io/structured-merge-diff/v4: v4.4.1 → v4.4.2
...
### Release notes for 3.3.0-rc.1 / 2025-04-02  
#### [prometheus v3.3.0-rc.1](https://github.com/prometheus/prometheus/releases/tag/v3.3.0-rc.1)  
#### 2025-04-08  
...
#### [cni v1.3.0](https://github.com/containernetworking/cni/releases/tag/v1.3.0)  
#### 2025-04-07  
## What's Changed
...
#### [cloud-provider-aws v1.33.0-beta.0](https://github.com/kubernetes/cloud-provider-aws/releases/tag/v1.33.0-beta.0)  
#### 2025-04-10  
## What's Changed
* Version bump 1.32.0-rc.3 by @BDworak in https://github.com/kubernetes/cloud-provider-aws/pull/1080
* release 1.32.0 by @shizuchanw in https://github.com/kubernetes/cloud-provider-aws/pull/1084
* Update health checks to use Kube-Proxy when no other configuration is provided by @JoelSpeed in https://github.com/kubernetes/cloud-provider-aws/pull/622
* Bump actions/setup-go from 5.1.0 to 5.2.0 by @dependabot in https://github.com/kubernetes/cloud-provider-aws/pull/1083
* Bump peter-evans/create-pull-request from 6.0.4 to 7.0.6 by @dependabot in https://github.com/kubernetes/cloud-provider-aws/pull/1086
* Update dependencies to resolve CVE-2024-45338 by @lcpulzone in https://github.com/kubernetes/cloud-provider-aws/pull/1088
* Use typed client-go constructors for rate-limit related objects by @yue9944882 in https://github.com/kubernetes/cloud-provider-aws/pull/1089
* optimize tagging controller workqueue handling by @kmala in https://github.com/kubernetes/cloud-provider-aws/pull/1091
* ecr-credential-provider: Fix warning about no region in image ref by @cartermckinnon in https://github.com/kubernetes/cloud-provider-aws/pull/1030
* Requires node topology labels to be set for known supported instance … by @mmerkes in https://github.com/kubernetes/cloud-provider-aws/pull/1100
* Optimize node controller describe instances calls by @shiv-amz in https://github.com/kubernetes/cloud-provider-aws/pull/1109
* Bump peter-evans/create-pull-request from 7.0.6 to 7.0.7 by @dependabot in https://github.com/kubernetes/cloud-provider-aws/pull/1113
* Bump peter-evans/create-pull-request from 7.0.7 to 7.0.8 by @dependabot in https://github.com/kubernetes/cloud-provider-aws/pull/1115
* Bump golang.org/x/oauth2 to v0.27.0 by @yue9944882 in https://github.com/kubernetes/cloud-provider-aws/pull/1123
* Bump golang.org/x/crypto to v0.35.0 by @yue9944882 in https://github.com/kubernetes/cloud-provider-aws/pull/1124
* Bump go runner to v2.3.1-go1.23.2-bookworm.0 by @yue9944882 in https://github.com/kubernetes/cloud-provider-aws/pull/1125
* Bump actions/setup-go from 5.2.0 to 5.4.0 by @dependabot in https://github.com/kubernetes/cloud-provider-aws/pull/1121
* Enable concurrent workers for tagging controller by @shiv-amz in https://github.com/kubernetes/cloud-provider-aws/pull/1126
* Release 1.33.0-beta.0 by @shizuchanw in https://github.com/kubernetes/cloud-provider-aws/pull/1129

## New Contributors
* @lcpulzone made their first contribution in https://github.com/kubernetes/cloud-provider-aws/pull/1088
* @yue9944882 made their first contribution in https://github.com/kubernetes/cloud-provider-aws/pull/1089

**Full Changelog**: https://github.com/kubernetes/cloud-provider-aws/compare/v1.32.2...v1.33.0-beta.0  
### Release notes for v1.32.2  
#### [cloud-provider-aws v1.32.2](https://github.com/kubernetes/cloud-provider-aws/releases/tag/v1.32.2)  
#### 2025-04-10  
## What's Changed
* 1.32: Requires node topology labels to be set for known supported instance … by @mmerkes in https://github.com/kubernetes/cloud-provider-aws/pull/1103
* Automated cherry pick of #1109: Optimize node controller describe instances calls by @shiv-amz in https://github.com/kubernetes/cloud-provider-aws/pull/1110
* Release 1.32.2 by @shiv-amz in https://github.com/kubernetes/cloud-provider-aws/pull/1111


**Full Changelog**: https://github.com/kubernetes/cloud-provider-aws/compare/v1.32.1...v1.32.2  
## grpc/grpc  
### Release notes for Release v1.72.0-pre1  
#### [grpc v1.72.0-pre1](https://github.com/grpc/grpc/releases/tag/v1.72.0-pre1)  
#### 2025-04-08  
