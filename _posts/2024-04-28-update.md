...
We're in the period between releases right now. Shadow applications for the v1.31 release team is now open! You can find the more information about the shadow program as well as the tentative dates for the v1.31 release in [this announcement](https://groups.google.com/a/kubernetes.io/g/dev/c/nZMtsOyBm0k). The shadow applications runs until May 15th. The tentative dates for the v1.31 cycle is from May 13th to August 15th, 2024.
